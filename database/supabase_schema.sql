...
-- =============================================================================
-- OTP REQUESTS (otp_requests) & SECURE VERIFICATION RPC
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_otp_identifier_purpose ON public.otp_requests(identifier, purpose, status);
CREATE INDEX IF NOT EXISTS idx_otp_expiry ON public.otp_requests(expiry);
CREATE INDEX IF NOT EXISTS idx_otp_status ON public.otp_requests(status);
...
DROP POLICY IF EXISTS "otp_requests_insert_policy" ON public.otp_requests;
...
-- Server-Side Secure OTP Verification RPC
