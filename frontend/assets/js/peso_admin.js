...
(function (window, document) {
    ...
    // =========================================================================
    // 7. MODULE 5: SCHEDULING MANAGEMENT (Delegated to modular peso-admin-scheduling.js)
    // =========================================================================
    function renderSchedulingModule() {
        if (typeof window.initSchedulingModuleData === 'function') {
            window.initSchedulingModuleData();
        }
    }
...
<body>
    ...
    window.downloadActiveReportPDF = downloadActiveReportPDF;
